...
/**
 * 
 * Esta classe nos apresenta uma lista de produtos(Código, nome, quantidade e categoria) que estão em Pedido de forma iterativa, 
 * a lista é atualizada automaticamente com a sainda e entrada de produtos no Pedido.
 *
 */
